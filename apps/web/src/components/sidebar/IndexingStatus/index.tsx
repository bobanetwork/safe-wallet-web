...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.safe.boba.network'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.staging.safe.boba.network'
